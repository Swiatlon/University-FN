...
export const gradeValueEnumArray = Object.values(GradeValueEnum) as GradeValueEnum[];
...
export const passDateAttemptEnumArray = Object.values(PassDateAttemptEnum) as PassDateAttemptEnum[];
